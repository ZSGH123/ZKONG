...
public abstract class KBaBaseServlet extends HttpServlet {
	...
	public void initLeftAllLiveType(HttpServletRequest req, HttpServletResponse resp,IIndexService indexService) throws KBaException {
		HttpSession session=this.getSession();
		List<LiveContentInfo> allLiveLiveContentInfos=null;
		allLiveLiveContentInfos=(List<LiveContentInfo>) session.getAttribute("allLiveLiveContentInfos");
		if(allLiveLiveContentInfos!=null&&allLiveLiveContentInfos.size()>0) return;
