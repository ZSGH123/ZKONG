...
public class LiveRoomDetatilDao extends AbstractBaseDao
	...
	public static void main(String[] strs){
		try {
			List<LiveRoomDetailInfo> liveRoomDetailInfos=LiveRoomDetatilDao.getInstance().selectAllMoHu("英雄");
	...
	public List<LiveRoomDetailInfo> selectAllByLiveCotentId(LiveContent entity) throws SQLException {
		...
		sql=this.parseSqlStatement.getSql(NameSpace.LIVEROOMDETAILINFO,"selectAllByLiveCotentId");
	...
	@Override
	public List<LiveRoomDetailInfo> selectAllMoHu(String content) throws SQLException {
		String sql=null;
		Object[] params=null;
		
		if(content==null) return queryAllLiveRoomDetailInfo();
		
		content="%"+content+"%";
		
		sql=this.parseSqlStatement.getSql(NameSpace.LIVEROOMDETAILINFO,"selectALLMoHu");
		System.out.println(sql);
		params=new Object[]{content,content,content,content,content,content,content};
