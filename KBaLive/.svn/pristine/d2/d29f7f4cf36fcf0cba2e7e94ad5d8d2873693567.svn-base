...
public class RoomManagerInfoDao extends AbstractBaseDao implements IRoomManagerInfoDao,ResultSetHandler<List<RoomManagerInfo>>{
	...
	private static RoomManagerInfoDao roomManagerInfoDao;
	
	private RoomManagerInfoDao(){
		
	}
	
	public synchronized static RoomManagerInfoDao getInstance(){
		if(roomManagerInfoDao==null){
			roomManagerInfoDao=new RoomManagerInfoDao();
		}
		return roomManagerInfoDao;
	}
	/**
	 * 查询所有房管
	 */
