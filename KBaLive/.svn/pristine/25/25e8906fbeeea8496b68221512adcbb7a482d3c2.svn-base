		...
		<div class="container">
			...
			<div class="col-md-10">
				...
				<div class="earn_tab_tit">
					<dl>
						<dd class="active">
							<a href="my-exchange.html">充值记录</a>
						</dd>
					</dl>
				</div>	
			<div class="exchange_list">
					<div class="exchange_nr" style="display: block;">
						<table  class="table table-bordered table-hover" id="exchange-table" cellspacing="0" cellpadding="0">
							...
							<tbody>	
							<b:forEach items="${investRecords}" var="irs">
								<tr>
									<td >${irs.investRecordId}</td>
									<td >${irs.investCashNumber}</td>
									<td >${irs.kTypeId==1 ? "金K币":"银k币"}</td>
									<td >${irs.kTypeId==1 ? irs.investCashNumber : irs.investCashNumber}K</td>
									<td >支付宝</td>
									<td >${irs.investRecordTime}</td>
								</tr>
			            	</b:forEach>
