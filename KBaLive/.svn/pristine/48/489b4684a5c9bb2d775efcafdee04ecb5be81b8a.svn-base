			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 25px;">新增支付类型</h3>
					</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="payTypeName"
										name="payTypeName" placeholder="必须不大于三十个字符" />
								</div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-5">
									...
									id="payTypeRemark" name="payTypeRemark"></textarea>
								</div>
							</div>
		...
		$(function() {
			$("#findform").validate({
			 ...
			 function refreshParent() {
                 ...
                 $.ajax({
                     url:"backStagePayTypeAction.do?command=insertPayType",
                     type:"post",
                     dataType:"text",
                     async:false,
                     data:{
                          payTypeName:name,payTypeRemark:remark
                     },
