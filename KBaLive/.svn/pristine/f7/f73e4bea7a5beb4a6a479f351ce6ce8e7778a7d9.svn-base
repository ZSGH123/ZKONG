			...
			<div class="col-md-10">
				...
				<div class="row" id="exchange_type">
    				<div class="col-sm-3 col-md-6" id="bankcard_content">
    					<div class="thumbnail">
     						<div class="caption">
        						<img src="img/k-jin.png" align="left"/>
        						<span id="tool"><h5>银行卡兑换</h5></span>
        						<span id="tool-info-jin">可兑换的金K币：${userpropertys[0].kNumber==null ? 0 : userpropertys[0].kNumber }k</span>
        						<span id="tool-info-yin">可兑换的人民币：${userpropertys[0].kNumber==null ? 0 : userpropertys[0].kNumber*0.9}元</span>
					...
					<div class="col-sm-3 col-md-6" id="alipay_content">
    					<div class="thumbnail">
     						<div class="caption">
        						<img src="img/k-yin.png" align="left"/>
        						<span id="tool"><h5>支付宝兑换</h5></span>
        						<span id="tool-info-jin">可兑换的银K币：${userpropertys[1].kNumber==null ? 0 : userpropertys[1].kNumber }k</span>
        						<span id="tool-info-yin">可兑换的人民币：${userpropertys[1].kNumber==null ? 0 : userpropertys[1].kNumber*0.08}元</span>
								<div class="input-group" id="exchange-input">
