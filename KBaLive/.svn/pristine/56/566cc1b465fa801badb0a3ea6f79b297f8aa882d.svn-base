...
<head>
<meta charset="UTF-8">
<title>KBaLive-${singleLiveType.liveTypeName}直播</title>
			...
			<div class="col-md-12">
				...
				<div id="ad">
					<div class="row">
						<div class="col-md-4" style="padding: 0px 10px 0px 15px;">
							<a href="javascript:;"><img src="images/ad/ad1.png" width="400px"
								alt="广告" class="img-rounded"></a>
						</div>
						<div class="col-md-4" style="padding: 0px;">
							<a href="javascript:;"><img src="images/ad/ad2.png" width="400px"
								alt="广告" class="img-rounded"></a>
						</div>
				...
				<div class="panel  panel-warning">
						...
						<div class="title">
							<h3 style="display: inline-block;">
								<img src="img/video.png"
									style="margin-left: 1px;margin-right: 10px;margin-bottom: 3px;" />${singleLiveType.liveTypeName}
							</h3>
					...
					<div class="panel-body" style="padding:15px 15px 0px 15px">
						<ul id="liveroom_box">
							<c:forEach items="${allLiveTypeLiveRoomDetailInfos}" var="item">
								...
								<li id="liveroom">
									<div class="panel panel-warning">
										<div class="panel-heading" style="padding: 0px;">
											<a href="userAction.do?command=toLiveHome&liveRoomId=${liveRoomItem.liveRoomId}"><img
												src="${liveRoomItem.liveRoomRemark}" width="248px" /></a>
										</div>
										<div class="panel-body" style="padding: 5px;">
											<div>
												<h5 class="title">
													<a href="userAction.do?command=toLiveHome&liveRoomId=${liveRoomItem.liveRoomId}"
														style="font-size: 15px;">${userInfoItem.userName}:${liveRoomItem.liveRoomTilie}</a>
												</h5>
												<span class="tag "><a id="atag"
													href="LiveContentAction.do?liveContentId=${liveContent.liveContentId}" style="float: right;">${liveContent.liveContentName}</a></span>
												<div class="clear"></div>
											</div>
											<div>
												<span> <img
													...
													href="userAction.do?command=toLiveHome&liveRoomId=${liveRoomItem.liveRoomId}" style="font-size: 12px;">
