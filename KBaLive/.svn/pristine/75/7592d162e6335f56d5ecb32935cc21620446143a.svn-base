...
public class BackStageGiftInfoService implements IBackStageGiftInfoService{
	 ...
	 * @return
	 */
	public boolean checkGiftInfoByName(GiftInfo giftInfo) throws KBaException{
		try {
			giftInfo=this.giftInfoDao.querySingleByName(giftInfo);
			return giftInfo!=null?true:false;
		} catch (SQLException e) {
			throw new KBaException(e);
		}
	}
