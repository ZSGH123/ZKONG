			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 25px;">新增管理员信息</h3>
					</div>
					<div class="panel-body">
						...
						<form id="findform" method="post" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="backStageManagerName"
										name="backStageManagerName" placeholder="必须不大于三十个字符" />
								</div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="backStageManagerPassword"
										name="backStageManagerPassword" placeholder="6-10位的任意字符" />
								</div>
							</div>
							 <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="backStageManagerPosition"
										name="backStageManagerPosition" placeholder="0或者1" />
								</div>
							</div>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-5">
									<textarea  class="form-control"  placeholder="普通管理员职位为0，超级管理员职位为1" 
									id="backStageManagerRemark" name="backStageManagerRemark"></textarea>
								</div>
							</div>
		...
		$(function() {
			$("#findform").validate({
			 ...
			 function refreshParent() {
                ...
                if(name.length!=0){
                 $.ajax({
                     url:"managerInfoAction.do?command=insertManager",
                     type:"post",
                     dataType:"text",
                     async:false,
                     data:{
                          backStageManagerName:name,backStageManagerPassword:pwd,backStageManagerPosition:pos,backStageManagerRemark:remark
                     },
