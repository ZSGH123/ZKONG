...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="afterReportMessageAction.do">举报记录查询</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 举报记录查询</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${reportmessages}" var="item" varStatus="index">
    	<tr >
        <td id="td1">${item.userId}</td>
        <td class="center" id="td2">${item.liveRoomId}</td>
        <td class="center" id="td3">${item.reportContent}</td>
        <td class="center" id="td4">${item.reportHandleResult}</td>
        <td class="center" id="td5">${item.reportTime}</td>
        <td class="center">
            <span class="label-success label label-default" id="td6">${item.reportMessageRemark}</span>
        </td>
        </tr>
    	</c:forEach>
