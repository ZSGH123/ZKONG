			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 25px;">修改k币类型</h3>
					</div>
					<div class="panel-body">
						<div class="jumbotron" style="padding: 20px;">
                            ...
                            <div id="kTypeId" style="display:none;" >${updateOfKType.kTypeId}</div>
						<form id="findform" method="post" class="form-horizontal"
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="kTypeName"
										name="kTypeName" value="${updateOfKType.kTypeName}" />
								</div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="kExchangeRate"
										name="kExchangeRate" value="${updateOfKType.kExchangeRate}" />
								</div>
							</div>
							 <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="kWithdrawRate"
										name="kWithdrawRate" value="${updateOfKType.kWithdrawRate}"/>
								</div>
							</div>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-5">
									...
									id="kRemark" name="kRemark">${updateOfKType.kRemark}</textarea>
								</div>
							</div>
		...
		$(function() {
			$("#findform").validate({
			 ...
			 function refreshParent() {
                 ...
                 $.ajax({
                     url:"backStageKTypeAction.do?command=updateKType",
                     type:"post",
                     dataType:"text",
                     async:false,
                     data:{
                         kTypeId:id,kTypeName:kTName,kExchangeRate:kERate,kWithdrawRate:kWRate,kRemark:remark
                     },
