...
<head>
    ...
    <script src='js/userlevel-index.js'></script>
...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="backStageUserLevelAction.do">用户等级设置</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 用户等级设置</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${userLevels}" var="usl" varStatus="index">
    	<tr >
        <td class="center" id="td1">${usl.userLevelId}</td>
        <td class="center" id="td2">${usl.userLevelName}</td>
        <td class="center" id="td3">${usl.userLowInvest}￥</td>
        <td class="center" id="td5">${usl.userHighInvest}￥</td>
        <td class="center" id="td5">${usl.userLevelRemark}</td>
  
        <td class="center">
            <a class="btn btn-success"  href="javascript:openUserLevelInsert()">  
            <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                新增
            </a>
            <a class="btn btn-info" href="javascript:userLevelUpdate(${usl.userLevelId})">
                <i class="glyphicon glyphicon-修改 icon-white"></i>
                修改
            </a>
            <a class="btn btn-danger" href="javascript:deleteUserLevel(${usl.userLevelId})">
