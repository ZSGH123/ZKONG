...
<head>
    ...
    <script src='js/giftinfoset-index.js'></script>
    <!-- jQuery -->
...
<body>
				...
				<div class="col-sm-2 col-lg-2">
					<div class="sidebar-nav">
						<div class="nav-canvas">
                         ...
                         <li class="accordion">
                            <a href="backStageIndexAction.do"><i class="glyphicon glyphicon-plus"></i><span> 等级设置</span></a>
                            <ul class="nav nav-pills nav-stacked">
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="backStageGiftTypeAction.do">礼物类型设置</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 礼物类型设置</h2>
    ...
    <div id="hidden" style="display:none;">${loginManager.backStageManagerPosition}</div>
    </thead>
    <tbody id="tdata">
    	<c:forEach items="${giftInfos}" var="item" varStatus="index">
    	<tr >
        <td class="center" >${item.giftId}</td>
        <td class="center">${item.giftName}</td>
        <td class="center">${item.giftPrice}</td>
        <td class="center" >${item.kTypeId}</td>
        <td class="center" >${item.giftIconAddress}</td>
        <td class="center">
            <span class="label-success label label-default" >${item.giftInfoRemark}</span>
        </td>
  
        <td class="center">
            <a class="btn btn-success"  href="javascript:openGiftInfoInsert()">  
            <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                新增
            </a>
            <a class="btn btn-info" href="javascript:giftInfoUpdate(${item.giftId})">
                <i class="glyphicon glyphicon-修改 icon-white"></i>
                修改
            </a>
            <a class="btn btn-danger" href="javascript:deleteGiftInfo(${item.giftId})">
