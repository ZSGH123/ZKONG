...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="afterLiveRecordAction.do">直播记录查询</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 直播记录查询</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${liverecords}" var="item" varStatus="index">
    	<tr >
        <td id="td1">${item.userId}</td>
        <td class="center" id="td2">${item.onLiveTime}</td>
        <td class="center" id="td3">${item.offLiveTime}</td>
        <td class="center">
            <span class="label-success label label-default" id="td4">${item.liveRecordRemark}</span>
        </td>
        </tr>
    	</c:forEach>
