...
public class VideoBrowseRecordDao extends AbstractBaseDao implements IVideoBrowseRecordDao,ResultSetHandler<List<VideoBrowseRecord>>{
	...
	private static VideoBrowseRecordDao videoBrowseRecordDao;
	
	private VideoBrowseRecordDao(){
		
	}
	
	public synchronized static VideoBrowseRecordDao getInstance(){
		if(videoBrowseRecordDao==null){
			videoBrowseRecordDao=new VideoBrowseRecordDao();
		}
		return videoBrowseRecordDao;
	}
	/**
	 * 查询所有视频浏览记录
	 */
