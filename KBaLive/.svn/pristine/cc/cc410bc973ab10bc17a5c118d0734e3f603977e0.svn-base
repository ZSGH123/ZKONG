...
<head>
    ...
    <script src='js/paytypeset-index.js'></script>
    <!-- jQuery -->
...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="backStagePayTypeAction.do">支付类型设置</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 支付类型设置</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${payTypes}" var="pt" varStatus="index">
    	<tr >
        <td class="center" id="td1">${pt.payTypeId}</td>
        <td class="center" id="td2">${pt.payTypeName}</td>
        <td class="center" id="td3">${pt.payTypeRemark}</td>
  
        <td class="center">
            <a class="btn btn-success"  href="javascript:openPayTypeInsert()">  
            <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                新增
            </a>
            <a class="btn btn-info" href="javascript:payTypeUpdate(${pt.payTypeId})">
                <i class="glyphicon glyphicon-修改 icon-white"></i>
                修改
            </a>
            <a class="btn btn-danger" href="javascript:deletePayType(${pt.payTypeId})">
