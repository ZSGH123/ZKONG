                        ...
                        <div class="userinfo clearfix">
                			<div id="js-invisible-taste" class="invisible-taste-switch"></div>
                           	<div class="uinfo_left fl">
                                <div class="utx fl">
                                    <img src='${empty loginUser.userIcon ? "img/defaultusericon.png":loginUser.userIcon}' width="100" height="80" alt=""/>
                                </div>
                                        ...
                                        <div class="m_rank clearfix">
                                            <div class="m_rank_item">
                                                ...
                                                <a class="bar fl" id="bar" >
                                                    ...
                                                    <span id="leverline" class="bar_per" style="width: ${userpropertys[0].kNumber==null ? 0 : userpropertys[0].kNumber%20*5}%;"></span>
                    		...
                    		<div class="col-sm-3 col-md-6" id="phone">
                    			    <div class="thumbnail">
     									...
     									<div class="caption">
        									...
        									<span><a href="${loginUser.userPhoneNumber==null ? 'reset-phone.jsp':'phone.jsp'}" class="btn btn-primary" role="button">${loginUser.userPhoneNumber==null ? "绑定手机":"换  绑"}</a> </span>
      									</div>
    								</div>	
                    		</div>
                    		<div class="col-sm-3 col-md-6" id="password">
                    			    <div class="thumbnail">
     									...
     									<div class="caption">
        									...
        									<span><a href="modify-password.jsp" class="btn btn-primary" role="button">修改密码</a> </span>
      									</div>
    								</div>
                    		</div>
                    		<div class="col-sm-3 col-md-6" id="IDCard">
                    			    <div class="thumbnail">
     									...
     									<div class="caption">
        									...
        									<span><a href="${loginUser.userIdCard==null ? 'id-card.jsp' : 'javascript:;'}" class="btn btn-primary" role="button">${loginUser.userIdCard==null ? "实名认证":"已认证"}</a> </span>
      									</div>
    								</div>	
                    		</div>
                    		<div class="col-sm-3 col-md-6" id="bankCard">
                    			    <div class="thumbnail">
     									...
     									<div class="caption">
        									...
        									<span><a href="bank-card.jsp" class="btn btn-primary" role="button">${loginUser.userBankCard==null ? "绑定银行卡":"已绑定"}</a> </span>
      									</div>
    								</div>	
                    		</div>
