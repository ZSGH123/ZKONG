...
<head>
    ...
    <script src='js/ktypeset-index.js'></script>
    <!-- jQuery -->
...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="backStageKTypeAction.do">K币类型设置</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> K币类型设置</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${kTypes}" var="item" varStatus="index">
    	<tr >
        <td class="center" >${item.kTypeId}</td>
        <td class="center">${item.kTypeName}</td>
        <td class="center">${item.kExchangeRate}</td>
        <td class="center" >${item.kWithdrawRate}</td>
        <td class="center">
            <span class="label-success label label-default" >${item.kRemark}</span>
        </td>
  
        <td class="center">
            <a class="btn btn-success"  href="javascript:openKTypeInsert()">  
            <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                新增
            </a>
            <a class="btn btn-info" href="javascript:kTypeUpdate(${item.kTypeId})">
                <i class="glyphicon glyphicon-修改 icon-white"></i>
                修改
            </a>
            <a class="btn btn-danger" href="javascript:deleteKType(${item.kTypeId})">
