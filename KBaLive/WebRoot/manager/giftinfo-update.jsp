...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-197" data-genuitec-path="/KBaLive/WebRoot/find-password.jsp">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 25px;">修改礼物信息</h3>
					</div>
					<div class="panel-body">
						<div class="jumbotron" style="padding: 20px;">
                            ...
                            <div id="giftId" style="display:none;" >${updateOfGiftInfo.giftId}</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="giftName"
										name="giftName" value="${updateOfGiftInfo.giftName}" />
								</div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="giftPrice"
										name="giftPrice" value="${updateOfGiftInfo.giftPrice}" />
								</div>
							</div>
							 <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="kTypeId"
										name="kTypeId" value="${updateOfGiftInfo.kTypeId}"/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="giftIconAddress"
										name="giftIconAddress" value="${updateOfGiftInfo.giftIconAddress}"/>
								</div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-5">
									...
									id="giftInfoRemark" name="giftInfoRemark">${updateOfGiftInfo.giftInfoRemark}</textarea>
								</div>
							</div>
	...
	$(function() {
			$("#findform").validate({
				rules : {
					giftName : {
						...
						maxlength : 30,
						remote : {
							url : "backStageGiftTypeAction.do?command=checkGiftInfoByName", //后台处理程序
							type : "post", //数据发送方式
			 ...
			 function refreshParent(){
	            ...
	            var name=$("#giftName").val();
                 ...
                 $.ajax({
                     url:"backStageGiftTypeAction.do?command=updateGiftInfo",
                     type:"post",
                     dataType:"text",
                     async:false,
                     data:{
                          giftId:id,giftName:name,giftPrice:price,kTypeId:kType,giftIconAddress:icon,giftInfoRemark:remark
                     },
	      ...
	      function closeWindow(){
	        $.post("backStageGiftTypeAction.do?command=quXiao",function(data){
	            if(data){
	               window.location.href="backStageGiftTypeAction.do";      
	            }else{
	               confirm("关闭失败了");
