...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="afterTransformRecordAction.do">提现记录查询</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 提现记录查询</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${transformrecords}" var="item" varStatus="index">
    	<tr >
        <td id="td1">${item.anchorId}</td>
        <td class="center" id="td2">${item.giftId}</td>
        <td class="center" id="td3">${item.giftNum}</td>
        <td class="center" id="td4">${item.kTypeId}</td>
        <td class="center" id="td5">${item.kNum}</td>
        <td class="center" id="td6">${item.transformTime}</td>
        <td class="center">
            <span class="label-success label label-default" id="td7">${item.transformRecordRemark}</span>
        </td>
        </tr>
    	</c:forEach>
