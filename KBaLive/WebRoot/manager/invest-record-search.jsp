...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="afterInvestSearchAction.do">充值记录查询</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 充值记录查询</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${investrecords}" var="item" varStatus="index">
    	<tr >
        <td id="td1">${item.userId}</td>
        <td class="center" id="td2">${item.investCashNumber}</td>
        <td class="center" id="td3">${item.investRecordTime}</td>
        <td class="center">
            <span class="label-success label label-default" id="td4">${item.investRecordRemark}</span>
        </td>
        </tr>
    	</c:forEach>
