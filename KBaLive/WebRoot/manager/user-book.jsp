...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="afterUserBookAction.do">订阅记录查询</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 订阅记录查询</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${userbooks}" var="item" varStatus="index">
    	<tr >
        <td id="td1">${item.userId}</td>
        <td class="center" id="td2">${item.anchorId}</td>
        <td class="center" id="td3">${item.userBookTime}</td>
        <td class="center" id="td4">${item.userTakeOffTime}</td>
        <td class="center">
            <span class="label-success label label-default" id="td5">${item.userBookRemark}</span>
        </td>
        </tr>
    	</c:forEach>
