...
<head>
    ...
    <script src='js/anchorlevel-index.js'></script>
    <!-- jQuery -->
...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="backStageAnchorLevelAction.do">主播等级设置</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 主播等级设置</h2>
    ...
    <tbody id="tdata">
    	<c:forEach items="${anchorLevels}" var="anl" varStatus="index">
    	<tr >
        <td class="center" >${anl.anchorLevelId}</td>
        <td class="center">${anl.anchorLevelName}</td>
        <td class="center">${anl.liveMinTotalTime}H</td>
        <td class="center" >${anl.liveMaxTotalTime}H</td>
        <td class="center">
            <span class="label-success label label-default" >${anl.anchorLevelRemark}</span>
        </td>
  
        <td class="center">
            <a class="btn btn-success"  href="javascript:openAnchorLevelInsert()">  
            <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                新增
            </a>
            <a class="btn btn-info" href="javascript:anchorLevelUpdate(${anl.anchorLevelId})">
                <i class="glyphicon glyphicon-修改 icon-white"></i>
                修改
            </a>
            <a class="btn btn-danger" href="javascript:deleteAnchorLevel(${anl.anchorLevelId})">
