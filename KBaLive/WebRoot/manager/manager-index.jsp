...
<body>
				...
				<div id="content" class="col-lg-10 col-sm-10">
					...
					<div>
						<ul class="breadcrumb">
							...
							<li>
								<a href="managerInfoAction.do">管理员设置</a>
							</li>
						</ul>
					</div>
					<!--
    ...
    <tbody id="tdata">
    	<c:forEach items="${managers}" var="mag" varStatus="index">
    	<tr >
        <td class="center" >${mag.backStageManagerId}</td>
        ...
        <td class="center">
            <a class="btn btn-success"  href="javascript:openManagerInsert()">  
            <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                新增
            </a>
            <a class="btn btn-info" href="javascript:managerUpdate(${mag.backStageManagerId})">
                <i class="glyphicon glyphicon-修改 icon-white"></i>
                修改
            </a>
            <a class="btn btn-danger" href="javascript:deleteManagerUser(${mag.backStageManagerId})">
