...
<html>
	...
	<body>
		...
		<div class="container" id="container">
          ...
          <div class="col_1">
            ...
            <div class="col_1">
                <ul class="greybox">
                    <c:forEach items="${liveContents2}" var="item" begin='0' end='2'>
                      <li><a href="LiveContentAction.do?liveContentId=${item.liveContentId}">${item.liveContentName}</a></li>
                    </c:forEach> 
    ...
    <div class="input-group" style="width: 200px;">
      <form id="findform" method="post" class="form-horizontal" action="indexAction.do?command=toSearch">
        <div class="form-group">
            <div class="input-group">
            <input type="text" class="form-control" placeholder="上官虹燚" style="width:100px height=40px; border-bottom-left-radius: 20px; border-top-left-radius: 20px;" name="content" >
            <span class="input-group-btn">
				...
				<a href="${empty loginUser ?  'login.jsp' : 'userAction.do?command=toAnchorCenter'}">开播</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href='${empty loginUser ?  "login.jsp" : "userAction.do?command=persional"}'>
				<img src='${empty loginUser.userIcon ? "img/defaultusericon.png":loginUser.userIcon}'  style="border-radius:50% ;" width='20px' >${empty loginUser ? "登录":loginUser.userName}</a>
