			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 25px;">安全验证</h3>
					</div>
					<div class="panel-body">
						<div class="jumbotron" style="padding: 20px;">
							<p style="margin: 0px; font-size: 20px;">您将要绑定新手机,为了保障账号安全,绑定新手机号之前,需验证身份</p>
						</div>
						<form id="findform" method="post" class="form-horizontal"
							action="userAction.do?command=toResetphone">
			...
			$("#findform").validate({
				rules : {
					userPhoneNumber : {
						...
						phone : true,
						remote : {
							url : "userAction.do?command=safetyCheck", //后台处理程序
							type : "post", //数据发送方式
