			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 25px;">绑定新的手机号</h3>
					</div>
					<div class="panel-body">
						<div class="jumbotron" style="padding: 20px;">
							<p style="margin: 0px; font-size: 20px;">您的账号:${loginUser.userId}正在绑定手机号</p>
						</div>
						<form id="findform" method="post" class="form-horizontal"
							action="userAction.do?command=toSetPhone">
		...
		$(function() {
			$("#findform").validate({
				rules : {
					userPhoneNumber : {
						...
						phone : true,
						remote : {
							url : "userAction.do?command=bundleNewPhone", //后台处理程序
							type : "post", //数据发送方式
	        ...
	        $("#sureBtn").click(function(){
			   ...
			   /**
		         ...
		         */
			function sendCode() {
			    var err=$("#userPhoneNumber-error").html();
				if ( err!= "") {
					console.log("手机号错误");
					return;
				} else {
					console.log("手机号：" + $("#userPhoneNumber").val())
					times = 60;
					//发送验证码
