			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title" style="font-size: 25px;">找回密码-重置密码</h3>
					</div>
					<div class="panel-body">
						<div class="jumbotron" style="padding: 20px;">
							<p style="margin: 0px; font-size: 20px;">
								您正在找回的账号是：<span id="userName">${resetPasswordUser.userName}${loginUser.userName}</span>
							</p>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="hidden" class="form-control" id="userName"
										value="${resetPasswordUser.userName}" name="userName" readonly="true"/> <input
